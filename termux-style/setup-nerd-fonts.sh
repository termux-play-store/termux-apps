...
getNerdFont() {
	...
	if [ "$font_filename_remote" = "Noto-Sans-Mono" ]; then
	
	elif [ "$font_filename_remote" != "Go-Mono" ]; then
	...
	local local_file="src/main/assets/fonts/${font_name}.ttf"
...
declare -A fonts=( # [font-name]='path/to/file.ttf'
	...
	[JetBrains-Mono]='Ligatures/Regular/JetBrainsMonoNerdFont-Regular.ttf'
  ...
  [Noto-Sans-Mono]=''
  https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/Noto/Sans-Mono/NotoSansMNerdFont-Regular.ttf
