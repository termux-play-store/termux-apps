...
public abstract class ResultReturner {
     ...
     */
    public static void noteDone(Service receiver, final Intent intent) {
     ...
     */
    public static void returnData(Context context, final Intent intent, final ResultWriter resultWriter) {
