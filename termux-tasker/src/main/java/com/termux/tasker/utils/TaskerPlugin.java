...
public class TaskerPlugin {
    ...
    public final static String VARIABLE_NAME_MAIN_PART_MATCH_EXPRESSION = VARIABLE_NAME_START_EXPRESSION + VARIABLE_NAME_MID_EXPRESSION + VARIABLE_NAME_END_EXPRESSION;

    public final static String VARIABLE_NAME_MATCH_EXPRESSION = VARIABLE_PREFIX + "+" + VARIABLE_NAME_MAIN_PART_MATCH_EXPRESSION;
    ...
    public final static int EXTRA_HOST_CAPABILITY_ALL = EXTRA_HOST_CAPABILITY_SETTING_RETURN_VARIABLES | EXTRA_HOST_CAPABILITY_CONDITION_RETURN_VARIABLES | EXTRA_HOST_CAPABILITY_SETTING_FIRE_VARIABLE_REPLACEMENT | EXTRA_HOST_CAPABILITY_RELEVANT_VARIABLES | EXTRA_HOST_CAPABILITY_SETTING_SYNCHRONOUS_EXECUTION | EXTRA_HOST_CAPABILITY_REQUEST_QUERY_DATA_PASS_THROUGH | EXTRA_HOST_CAPABILITY_ENCODING_JSON;
    ...
    public static boolean variableNameValid(String varName) {
        ...
        if (varName == null) Log.d(TAG, "variableNameValid: null name");
        else {
            ...
            if (VARIABLE_NAME_MATCH_PATTERN.matcher(varName).matches()) {
                ...
                if (variableNameIsLocal(varName)) validFlag = true;
                else Log.d(TAG, "variableNameValid: name not local: " + varName);
            } else Log.d(TAG, "variableNameValid: invalid name: " + varName);
        }
    ...
    public static String[] getRelevantVariableList(Bundle fromHostIntentExtras) {
        ...
        if (relevantVars == null) relevantVars = new String[0];
    ...
    public static void setKeyEncoding(Bundle resultBundleToHost, String[] keys, Encoding encoding) {
        if (Encoding.JSON.equals(encoding))
            addStringArrayToBundleAsString(keys, resultBundleToHost, BUNDLE_KEY_ENCODING_JSON_KEYS, "setValueEncoding");
        else Log.e(TAG, "unknown encoding: " + encoding);
    }
    ...
    public static class Setting {
        ...
        public static boolean hostSupportsOnFireVariableReplacement(Activity editActivity) {
            ...
            if (!supportedFlag) {
                ...
                if (callingActivity == null)
                    ...
                    supportedFlag = (callerPackage.startsWith(BASE_KEY)) && (getPackageVersionCode(editActivity.getPackageManager(), callerPackage) > FIRST_ON_FIRE_VARIABLES_TASKER_VERSION);
                }
            }
        ...
        public static void requestTimeoutMS(Intent intentToHost, int timeoutMS) {
            if (timeoutMS < 0)
                ...
                if ((timeoutMS > REQUESTED_TIMEOUT_MS_MAX) && (timeoutMS != REQUESTED_TIMEOUT_MS_NEVER)) {
        ...
        public static void setVariableReplaceKeys(Bundle resultBundleToHost, String[] listOfKeyNames) {
            addStringArrayToBundleAsString(listOfKeyNames, resultBundleToHost, BUNDLE_KEY_VARIABLE_REPLACE_STRINGS, "setVariableReplaceKeys");
        }
    ...
    public static class Event {
        ...
        public static Bundle retrievePassThroughData(Intent queryConditionIntent) {
            return (Bundle) getExtraValueSafe(queryConditionIntent, EXTRA_REQUEST_QUERY_PASS_THROUGH_DATA, Bundle.class, "retrievePassThroughData");
        }
        ...
        public static int retrievePassThroughMessageID(Intent queryConditionIntent) {
            ...
            if (passThroughData != null) {
                Integer id = (Integer) getBundleValueSafe(passThroughData, PASS_THROUGH_BUNDLE_MESSAGE_ID_KEY, Integer.class, "retrievePassThroughMessageID");

                if (id != null) toReturn = id;
            }
    ...
    public static class Host {
        ...
        public static void addCompletionIntent(Intent fireIntent, Intent completionIntent, ComponentName callService, boolean foreground) {
            ...
            fireIntent.putExtra(Setting.EXTRA_PLUGIN_COMPLETION_INTENT, completionIntent.toUri(Intent.URI_INTENT_SCHEME));
        }
        ...
        public static int getRequestedTimeoutMS(Bundle extrasFromPluginEditActivity) {
            return (Integer) getBundleValueSafe(extrasFromPluginEditActivity, Setting.EXTRA_REQUESTED_TIMEOUT, Integer.class, "getRequestedTimeout");
        }

        public static String[] getSettingVariableReplaceKeys(Bundle fromPluginEditActivity) {
            return getStringArrayFromBundleString(fromPluginEditActivity, Setting.BUNDLE_KEY_VARIABLE_REPLACE_STRINGS, "getSettingVariableReplaceKeys");
        }
        ...
        public static String[] getKeysWithEncoding(Bundle fromPluginEditActivity, Encoding encoding) {
            ...
            if (Encoding.JSON.equals(encoding))
                toReturn = getStringArrayFromBundleString(fromPluginEditActivity, TaskerPlugin.BUNDLE_KEY_ENCODING_JSON_KEYS, "getKeyEncoding:JSON");
            else Log.w(TAG, "Host.getKeyEncoding: unknown encoding " + encoding);
    ...
    private static Object getBundleValueSafe(Bundle b, String key, Class<?> expectedClass, String funcName) {
        ...
        if (b != null) {
            if (b.containsKey(key)) {
                ...
                if (obj == null) Log.w(TAG, funcName + ": " + key + ": null value");
    ...
    private static Object getExtraValueSafe(Intent i, String key, Class<?> expectedClass, String funcName) {
        return (i.hasExtra(key)) ? getBundleValueSafe(i.getExtras(), key, expectedClass, funcName) : null;
    }
    ...
    private static boolean variableNameIsLocal(String varName) {
        ...
        if (digitCount == (varName.length() - 1)) return false;
    ...
    private static String[] getStringArrayFromBundleString(Bundle bundle, String key, String funcName) {
        ...
        if (spec != null) toReturn = spec.split(" ");
    ...
    private static void addStringArrayToBundleAsString(String[] toAdd, Bundle bundle, String key, String callerName) {
        ...
        if (toAdd != null) {
            ...
            for (String keyName : toAdd) {
                ...
                if (builder.length() > 0) bundle.putString(key, builder.toString());
            }
        }
    }
