...
public class SocketListener {
    ...
    public static final String LISTEN_ADDRESS = TermuxAPIConstants.TERMUX_API_PACKAGE_NAME + "://listen";
                ...
                try (LocalServerSocket listen = new LocalServerSocket(LISTEN_ADDRESS)) {
                    while (true) {
                        try (LocalSocket con = listen.accept();
                            ...
                            // TODO: Query termux uid
                            Log.e("termux", "PEER UID=" + con.getPeerCredentials().getUid() + ", app=" + app.getApplicationInfo().uid);
                            ...
                            try {
                                ...
                                Log.e(LOG_TAG, "Error parsing arguments", e);
                    ...
                    Log.e(LOG_TAG, "Error listening for connections", e);
                }
            });
            listener.start();
        }
